-- Add the Trello webhook trigger type to launch's TriggerType enum.
-- Without it, CreateTrigger's INSERT INTO trigger (type) ... = 'trello-webhook'
...
-- has already been applied. This must merge AFTER 33 (jira-webhook).
ALTER TYPE TriggerType ADD VALUE IF NOT EXISTS 'trello-webhook';
